...
import com.kwh.airquality.databinding.ActivityMainBinding
import com.kwh.airquality.retrofit.AirQualityResponse
import com.kwh.airquality.retrofit.AirQualityService
import com.kwh.airquality.retrofit.RetrofitConnection
...
//            val address = getCurrentAddress(35.12188, 129.0419)
            ...
            Toast.makeText(
                this@MainActivity, "위도, 경도 정보를 가져올 수 없었습니다. 새로고침을 눌러주세요.",
                Toast.LENGTH_LONG
            ).show()
        }
    }
    ...
    private fun getAirQualityData(latitude: Double, longitude: Double) {
        ...
        retrofitAPI.getAirQualityData(
            latitude.toString(),
            longitude.toString(),
            "578bfbed-882c-42c0-982d-55a1f66e6fe7",
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful){
                    Toast.makeText(this@MainActivity, "최선 정보 업데이트 완료!",
        ...
        getGPSPermissionLauncher = registerForActivityResult(
            ...
            if (result.resultCode == Activity.RESULT_OK) {
                if (isLocationServicesAvailable()) {
                    ...
                    Toast.makeText(
                        this@MainActivity, "위치 서비스를 사용할 수 없습니다",
                        Toast.LENGTH_SHORT
                    ).show()
                    finish()
                }
